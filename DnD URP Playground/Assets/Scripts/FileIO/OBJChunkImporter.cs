...
public class OBJChunkImporter: MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        importer = GetComponent<ImportObjectFromFile>();
    }
    ...
    public IEnumerator ConstructMesh(string filePath)
    {
        ...
        foreach (Vector3 v in newMesh.faceData)
        {
            ...
            if(i % 100 == 0)
            {
                infoText.text = "Faces Loaded: " + i.ToString();
                yield return null;
            }
        }
    ...
    {
        StartCoroutine(ConstructMesh(filePath));
    }
